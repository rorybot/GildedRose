...
describe GildedRose do
  describe '#update_quality' do
    it 'does not change the name' do
      items = [Item.new(ItemName.new('foo'), SellBy.new(10), Quality.new(10))]
    ...
    it 'cannot go past 50' do
      items = [Item.new(ItemName.new('foo'), SellBy.new(10), Quality.new(50, false, true))]
      GildedRose.new(items).update_quality
    ...
    it 'cannot go below 0' do
      items = [Item.new(ItemName.new('foo'), SellBy.new(10), Quality.new(0))]
      GildedRose.new(items).update_quality
    ...
    context 'conjured items' do
      it 'increases twice as fast if a conjured item' do
        items = [Item.new(ItemName.new('Magic Pie [Conjured]'), SellBy.new(10), Quality.new(10))]
        GildedRose.new(items).update_quality
